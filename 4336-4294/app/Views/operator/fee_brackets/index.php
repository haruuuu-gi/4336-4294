...
<h5 class="mb-3">Barème de frais — <?= esc($type['libelle'] ?? '') ?></h5>
<a href="<?= site_url('operateur/types-operation') ?>" class="btn btn-sm btn-outline-secondary mb-3">&larr; Retour aux types</a>
    ...
    <div class="col-md-4">
        <div class="card shadow-sm mb-3">
            <div class="card-body">
                ...
                <form method="post" action="<?= site_url('operateur/types-operation/' . $type['id'] . '/baremes') ?>">
                    <?= csrf_field() ?>
                    <div class="mb-2">
        ...
        <table class="table table-striped bg-white shadow-sm">
            ...
            <?php foreach ($brackets as $b): ?>
                <tr>
                    ...
                    <td>
                        <a href="<?= site_url('operateur/baremes/' . $b['id'] . '/delete') ?>" class="btn btn-sm btn-outline-danger" onclick="return confirm('Supprimer cette tranche ?')">Supprimer</a>
                    </td>
                </tr>
            <?php endforeach; ?>
            </tbody>
